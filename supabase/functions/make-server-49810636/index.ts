...
const MATCH_DATES: Record<number, string> = {
  ...
  89:'2026-07-04T16:00:00-05:00', 90:'2026-07-04T12:00:00-05:00',
...
const SPORTSDB_EVENT_IDS: Record<number, string> = {
  ...
  // ── 8vos (Round of 16) — slot→fixture real mapeado vía bracket + eventsround r=16 (jul-2026) ──
  // 89 Paraguay-France · 90 Canada-Morocco · 91 Brazil-Norway · 92 Mexico-England
